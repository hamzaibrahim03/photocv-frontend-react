...
function EventPublic() {
        ...
        debounce(async (query) => {
            if (query.length >= 3 && query !== lastSearched) {
                ...
                try {
                    ...
                    const result = response?.data?.data?.events?.original?.data?.original?.data || [];
    ...
    useEffect(() => {
        const events = eventData?.events?.original?.data?.original?.data || [];
                                        ...
                                        <div className="col-12 col-md-4">
                                            <div className="social-col">
                                                ...
                                                <div className="social-item d-flex align-items-center justify-content-md-start justify-content-center" id="cle">
                                                    ...
                                                    <div id="facebook">
                                                        <p className="footer-text head mb-1" style={{ color: eventData?.clubSettings?.original?.data?.settings?.text_color }}>Facebook</p>
                                                ...
                                                <div className="social-item d-flex align-items-center justify-content-md-start justify-content-center" id="cle">
                                                    ...
                                                    <div id="facebook">
                                                        <p className="footer-text head mb-1" style={{ color: eventData?.clubSettings?.original?.data?.settings?.text_color }}>Instagram</p>
                                                ...
                                                <div className="social-item d-flex align-items-center justify-content-md-start justify-content-center" id="cle">
                                                    ...
                                                    <div id="facebook">
                                                        <p className="footer-text head mb-1" style={{ color: eventData?.clubSettings?.original?.data?.settings?.text_color }}>Flickr</p>

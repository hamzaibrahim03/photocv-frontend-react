                                        ...
                                        <div className="col-12 col-md-4">
                                            <div className="social-col">
                                                ...
                                                <div className="social-item d-flex align-items-center justify-content-md-start justify-content-center" id="cle">
                                                    ...
                                                    <div id="facebook">
                                                        <p className="footer-text fw-bold mb-1" style={{ color: clubgallerydata?.clubSettings?.original?.data?.settings?.text_color }}>Facebook</p>
                                                ...
                                                <div className="social-item d-flex align-items-center justify-content-md-start justify-content-center" id="cle">
                                                    ...
                                                    <div id="facebook">
                                                        <p className="footer-text fw-bold mb-1" style={{ color: clubgallerydata?.clubSettings?.original?.data?.settings?.text_color }}>Instagram</p>
                                                ...
                                                <div className="social-item d-flex align-items-center justify-content-md-start justify-content-center" id="cle">
                                                    ...
                                                    <div id="facebook">
                                                        <p className="footer-text fw-bold mb-1" style={{ color: clubgallerydata?.clubSettings?.original?.data?.settings?.text_color }}>Flickr</p>

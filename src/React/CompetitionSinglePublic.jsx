                                            ...
                                            <section>
                                                <div className="container" style={{ maxWidth: '1820px' }} id="events-left">
                                                    <div className="card" style={{ border: 'none' }}>
                                                        <img src={sincompData?.competition?.original?.data?.featured_image_url} alt="Meeting" style={{ maxWidth: '850px', marginBottom: '50px', width: '850px', height: '350px', borderRadius: '8px' }} />
                                                        <div className="d-flex justify-content-between" style={{ width: '850px' }}>
                                                            <h5 className="head" style={{ fontFamily: 'Inter', fontWeight: 500, fontStyle: "Medium", fontSize: "28px", lineHeight: "100%", letterSpacing: "0%", color: sincompData?.clubSettings?.original?.data?.settings?.text_color }}>{sincompData?.competition?.original?.data?.name}</h5>
                                                            <div className="d-flex align-items-center justify-content-center gap-3">
                                                                <img className="head" src={sincompData?.competition?.original?.data?.competition_type?.icon_url} style={{ width: '20px', height: '20px' }} />
                                                                <h5 className="head" style={{ color: sincompData?.clubSettings?.original?.data?.settings?.text_color, fontWeight: '400', fontStyle: 'Regular', fontSize: '18px', lineHeight: '100%', letterSpacing: '0%' }}>{sincompData?.competition?.original?.data?.competition_type?.name}</h5>
                                                            </div>
                                                        </div>
                                                        <p id="edate" style={{ color: sincompData?.clubSettings?.original?.data?.settings?.accent_color }}>{formatDate(sincompData?.competition?.original?.data?.start_date)}</p>
                                                        <p className="text-secondary" style={{ color: sincompData?.clubSettings?.original?.data?.settings?.text_color }}>
                                                        ...
                                                        <div className="row" id="eventdetails">
                                                            <div className="col-md-5">
                                                                <h5 className="clubhead" style={{ color: sincompData?.clubSettings?.original?.data?.settings?.accent_color }}>Competition Type</h5>
                                                            </div>
                                                        ...
                                                        <div className="row" id="eventdetails">
                                                            <div className="col-md-5">
                                                                <h5 className="clubhead" style={{ color: sincompData?.clubSettings?.original?.data?.settings?.accent_color }}>Competition Judge</h5>
                                                            </div>
                                                            <div className="col-md-7">
                                                        ...
                                                        <div className="row" id="eventdetails">
                                                            <div className="col-md-5">
                                                                <h5 className="clubhead" style={{ color: sincompData?.clubSettings?.original?.data?.settings?.accent_color }}>Theme</h5>
                                                            </div>
                                                            <div className="col-md-7">
                                                        ...
                                                        <div className="row" id="eventdetails">
                                                            <div className="col-md-5">
                                                                <h5 className="clubhead" style={{ color: sincompData?.clubSettings?.original?.data?.settings?.accent_color }}>Colour/Monochrome</h5>
                                                            </div>
                                                            <div className="col-md-7">
                                                        ...
                                                        <div className="row" id="eventdetails">
                                                            <div className="col-md-5">
                                                                <h5 className="clubhead" style={{ color: sincompData?.clubSettings?.original?.data?.settings?.accent_color }}>Status</h5>
                                                            </div>
                                                            <div className="col-md-7">
                                                        ...
                                                        <div className="row" id="eventdetails">
                                                            <div className="col-md-5">
                                                                <h5 className="clubhead" style={{ color: sincompData?.clubSettings?.original?.data?.settings?.accent_color }}>Gear Required</h5>
                                                            </div>
                                                            <div className="col-md-7">
                                                        ...
                                                        <div className="row" id="eventdetails">
                                                            <div className="col-md-5">
                                                                <h5 className="clubhead" style={{ color: sincompData?.clubSettings?.original?.data?.settings?.accent_color }}>Max Number of Entries per Participants</h5>
                                                            </div>
                                                            <div className="col-md-7">
                                                                <h5 className="clubhead" style={{ color: sincompData?.clubSettings?.original?.data?.settings?.text_color }}>
                                                        ...
                                                        <div className="row" id="eventdetails">
                                                            <div className="col-md-5">
                                                                <h5 className="clubhead" style={{ color: sincompData?.clubSettings?.original?.data?.settings?.accent_color }}>Deadline for Submission</h5>
                                                            </div>
                                                            <div className="col-md-7">
                                                        ...
                                                        <div className="row" id="eventdetails">
                                                            <div className="col-md-5">
                                                                <h5 className="clubhead" style={{ color: sincompData?.clubSettings?.original?.data?.settings?.accent_color }}>Result Announcement Date</h5>
                                                            </div>
                                                            <div className="col-md-7">
                                                                <h5 className="clubhead" style={{ color: sincompData?.clubSettings?.original?.data?.settings?.text_color }}>
                                                                ...
                                                                <div style={{ height: 'auto', border: 'none', backgroundColor: sincompData?.clubSettings?.original?.data?.settings?.background_color }}>
                                                                    <div className="d-flex justify-content-between align-items-end mb-3" id="cl">
                                                                        <div style={{ alignItems: 'flex-end' }}>
                                                                            <h5 className="head" style={{ color: sincompData?.clubSettings?.original?.data?.settings?.text_color }}>Competition Results</h5>
                                                                        </div>
                                                                    </div>
                            ...
                            <section id="joincontainer">
                                <div className="container" style={{ maxWidth: '1820px' }}>
                                    <div id="cls" className="join d-flex justify-content-between align-items-center flex-wrap gap-3 mb-4" style={{ backgroundColor: sincompData?.clubSettings?.original?.data?.settings?.secondary_color }}>
                                        <div>
                                            <h5 id="clubheading" className="heading" style={{ color: sincompData?.clubSettings?.original?.data?.settings?.text_color }}>
                                                Ready to join the club & work on something exciting?
                                            </h5>
                                            <p id="clubsub" className="head" style={{ color: sincompData?.clubSettings?.original?.data?.settings?.text_color, marginBottom: '0px' }}>
                            ...
                            <section>
                                <div className="container" style={{ maxWidth: '1820px' }}>
                                    <div className="footer-section" style={{ paddingTop: '30px' }}>
                                        <h5 id="footer-heading" className="heading footer-heading" style={{ color: sincompData?.clubSettings?.original?.data?.settings?.text_color }}> {sincompData?.clubSettings?.original?.data?.settings?.footer_text} </h5>
                                        <p id="footer-description" className="head footer-description mx-auto" style={{ color: sincompData?.clubSettings?.original?.data?.settings?.text_color }}> {sincompData?.clubSettings?.original?.data?.settings?.footer_description} </p>
                                    </div>
                                </div>
                            </section>
                                ...
                                <div className="container footer-section">
                                    <div className="row align-items-center text-center text-md-start">
                                        ...
                                        <div className="col-12 col-md-4 mb-4 mb-md-0 text-center" style={{ paddingTop: '-10px' }}>
                                            <img src={sincompData?.clubSettings?.original?.data?.settings?.footer_img_url} alt="sample" className="footer-img" />
                                        </div>

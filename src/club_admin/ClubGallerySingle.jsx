            ...
            <section className="content" style={{ padding: '0 30px' }}>
                <div className="container" style={{ maxWidth: '1810px', margin: '0 auto', padding: '0 15px' }}>
                    <div className="dashboard-card d-flex align-items-center justify-content-between py-4 gap-3">
                        <ClubProfile greeting="Galleries uploaded by Club" name="Food" role={`Image ${currentIndex + 1} of ${imageList.length}`} />
                    ...
                    <div className="card bg-white rounded p-4 border-0 mb-4" style={{ height: 'auto', minHeight: '600px', position: 'relative' }}>
                        <h5 className="mt-3 ms-2">Club Gallery - Food</h5>
                    ...
                    {/* Lightbox Implementation purely in React */}
                    {isLightboxOpen && (
                                ...
                                {[...Array(3)].map((_, i) => (
                                    <div key={i} className="row mb-3 pb-3 border-bottom">
                                        ...
                                        <div className="col-md-9 ms-3">
                                            <p className="m-0">
                                                <label className="fw-bold" style={{ color: '#cc445e' }}>User Name</label> This is a sample comment about the club gallery!
                                            </p>
